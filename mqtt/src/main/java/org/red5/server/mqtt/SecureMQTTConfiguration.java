...
/**
 * Provides configuration support for secure MQTT protocol.
 *  
 * @author Paul Gregoire (mondain@gmail.com)
 */
public class SecureMQTTConfiguration {

	private static Logger log = LoggerFactory.getLogger(SecureMQTTConfiguration.class);
